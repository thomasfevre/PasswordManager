...
export function HomePage2() {
    ...
    return (
        ...
        <div className="page-0">
            ...
            <img src={require("../images/Bag.png")} className="object" data-value="-2" alt=""/>
            <img src={require("../images/blockchain.png")} className="object" data-value="6" alt=""/>
            <img src={require("../images/cadena.png")} className="object" data-value="4" alt=""/>
            <img src={require("../images/encrypt.png")} className="object" data-value="-6" alt=""/>
            <img src={require("../images/web3identity.png")} className="object" data-value="8" alt=""/>
            <img src={require("../images/lock.png")} className="object" data-value="-4" alt=""/>
            <img src={require("../images/wallet.png")} className="object" data-value="5" alt=""/>
        ...
        <div className="page-1" id="page-1">
          ...
          <div className="page-header">
            ...
            <p>
              The purpose of this project is to provide a password manager using blockchain. By encrypting their passwords with their wallet (their public key), everyone can save their confidential data on the blockchain without the risk of theft or forgetting.
            </p><br/>
          ...
          <div className="flex">
            ...
            <div className="card">
              <div className="card2">
                ...
                <p className="card-text">Encrypt your data with your wallet</p>
              </div>
            </div>
            <div className="m-10"></div>
            <div className="card">
              <div className="card2">
                ...
                <p className="card-text">Access it anywhere through the blockchain</p>
              </div>
            </div>
          </div>
          <Link to="/main">
